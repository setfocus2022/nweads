    ...
    <>
      ...
      <main className={`${styles.treatments} mainContainer`}>
        ...
        <div className={styles.treatmentsItem} data-aos="fade-up">
         ...
         <p><font face="Arial" color="blue" > Indicado para negociação entre particulares </font></p> 
...
Se esse é o serviço que resolve o seu problema, clique no botão e me chame no WhatsApp. Se o que você precisa ainda não é isso, temos mais duas modalidades de avaliações que estão abaixo. Assista os vídeos e entenda qual delas é a melhor para você. </p>
        ...
        <div className={styles.treatmentsItem} data-aos="fade-up">
          ...
          <p><font face="Arial" color="blue" >Este serviço é ideal quando você precisa oferecer um imóvel como garantia para empresas, pessoas físicas e até algumas instituições financeiras, como consórcios ou operações de crédito.</font></p>
          <div className={styles.description}>
          <p>
